...
# 读基因名单
genes <- read_csv("/Users/gzy2520/Desktop/library/GO2_re.csv", show_col_types = FALSE) 
...
design <- sg2 %>%
  ...
  dplyr::left_join(gene_order, by = "Symbol") %>%        
  dplyr::mutate(
...
# 导出 
outfile <- "/Users/gzy2520/Desktop/library/oligo2.csv"
